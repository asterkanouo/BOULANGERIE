...
<div class="col-8 card bg-body rounded shadow-sm ">
  ...
  <div class="mb-3  px-3">
    <label for="exampleInputtext" class="form-label">Quantité de stock</label>
    <input type="text" class="form-control" required name="qte_stock">
  </div>
  </div>
  ...
  <div class="mb-3 px-3">
    <label for="exampleInputtext" class="form-label">Quantité sortie</label>
    <input type="text" class="form-control" required name="qte_sortie">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3 px-3">
    <label for="exampleInputtext" class="form-label">Quantité en attente</label>
    <input type="text" class="form-control" required name="qte_attente">
  </div>
