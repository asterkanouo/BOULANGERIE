     ...
     <div class="card-body ">
      <div class="row " style="margin-left: 0px;width: 1050px;">
        <div class=" mr-2  card rounded shadow-sm mb-4" style="margin-left: 90px;width: 460px;">
                ...
                <div class=" col-sm-4">
                <input type="text" id="datepicker" style="font-size: 20px;margin-bottom: 15px;margin-left: -90px;margin-top: 0px;width: 250px;" readonly="readonly" class="form-control" value="{{date('Y - M - d')}} " name="date_debut">
                </div>
            ...
            <div class=" form-group row" style="margin-top: -100px;font-size: 20px;width: 350px;margin-left: 600px;height: 40px;" >
                <label for="util" class="col-sm-12 form-label" style="margin-left: 70px;">Total mouvement: </label>
                <div class=" col-sm-12">
