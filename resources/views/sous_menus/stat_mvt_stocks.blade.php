...
<h5>Statistiques sur les mouvements des stocks</h5>
</div>
     <div class="card-body ">
      <div class="row " style="margin-left: 0px;width: 1380px;">
        <div class=" mr-2  card rounded shadow-sm mb-4" style="margin-left: -15px;width: 460px;">
                <div class=" card-body" style="height: 200px;width: 448px;" > 
                <form class="" style="height: 30px; margin-top: 0px;margin-left: 0px;width: 348px;" method="post" action="{{route('fact_en_cours_four')}}">
                 @csrf
                ...
                <div class=" col-sm-4">
                <input type="text" id="datepicker" style="font-size: 20px;margin-bottom: 15px;margin-left: -90px;margin-top: 0px;width: 270px;" readonly="readonly" class="form-control" value="{{date('d-F-Y')}} " name="date_debut">
                </div>
                <label for="util" class="col-sm-8 form-label" >Date de fin: </label>
                <div class=" col-sm-4">
                <input type="text" id="datepicker2" style="font-size: 20px;margin-left: -90px;margin-top: 0px;width: 270px;" readonly="readonly" class="form-control" value="{{date('d-F-Y')}} " name="date_debut">     
                 </div>
                </div> 
            </div>  
