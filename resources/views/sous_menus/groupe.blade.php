...
<ul class="nav">
  <li class="nav-item">
  <a href="{{route('groupe.create')}}" class = "navbar-brand text-white">Nouveau groupe</a>
  </li>
...
<h1 class="d-flex justify-content-center pb-2 mb-2 "><b><u>Groupes utilisateurs</u></b></h1>
    ...
    @foreach($groupes as $groupe)
      <tr>
        ...
        <a href="/groupe.delete/{{$groupe->code_groupe}}"   class= "btn btn-danger" onclick="return confirm('voulez-vous vraiment supprimer ce groupe?');" >Supprimer</a>
        </td>
      </tr>
      @endforeach
    </tbody>
