...
<h5>Liste des inventaires</h5>
  ...
  <tbody>
    ...
    <button class="btn btn-success" type="button" style="width: 248px;">Imprimer le détail de l'inventaire</button>
    <a class="btn btn-danger" href="{{route('welcome')}}" type="button" style="margin-left: 580px;background-color: rgb(255,15,0);">Fermer</a></div>
    </div>
